...
\begin{frame}{Online pro-ISIS network: daily snapshots}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.52\textwidth}
      \begin{figure}
        \centering
        \includegraphics[width=0.31\linewidth]{1A-1.png}\hfill
        \includegraphics[width=0.31\linewidth]{1A-2.png}\hfill
        \includegraphics[width=0.31\linewidth]{1A-3.png}
      \end{figure}
    \end{column}
  \end{columns}
...
\begin{frame}{Result (online): women exceed the degree null expectation}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.58\textwidth}
      \PaperFigureSlot[0.55\textheight]{1C.png}{
...
\begin{frame}{Offline PIRA network: how edges are formed}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.52\textwidth}
      \begin{figure}
        \centering
        \includegraphics[width=0.31\linewidth]{2A-1.png}\hfill
        \includegraphics[width=0.31\linewidth]{2A-2.png}\hfill
        \includegraphics[width=0.31\linewidth]{2A-3.png}
      \end{figure}
    \end{column}
  \end{columns}
...
\begin{frame}{Result (offline): PIRA activity rises while actor count does not}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.6\textwidth}
      \PaperFigureSlot[0.65\textheight]{2B.png}{
...
\begin{frame}{Productivity rises even as actor count falls}
  \small
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.3\textwidth}
      \begin{block}{Main point}
        PIRA output rises while the actor pool shrinks, so this is not a simple growth-in-size story.
      \end{block}
    \end{column}

    \begin{column}{0.7\textwidth}
      \PaperFigureSlot[0.80\textheight]{S2.png}{
        Supplementary figure S2: rising PIRA productivity alongside falling actor counts.
      }
    \end{column}
  \end{columns}
  ...
  \note{
    \textbf{Time: 1:15}\par
    \textbf{MUST SAY:}\par
    Make the negative claim explicit: more attacks did not come from simply having more people.\par
    This matters because the paper is shifting from raw productivity toward \alert{organizational structure} as an explanation.\par
    Then return to the centrality results.
  }
\end{frame}
...
\begin{frame}{Result (offline): women's betweenness rises above men's}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.65\textwidth}
      \PaperFigureSlot[0.65\textheight]{2C.png}{
...
\begin{frame}{Result (offline): women's degree centrality declines faster}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.62\textwidth}
      \PaperFigureSlot[0.65\textheight]{2D.png}{
...
\begin{frame}{Longevity (online): more women in groups, longer lifetimes}
  ...
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.62\textwidth}
      \PaperFigureSlot[0.5\textheight]{3A.png}{
...
\begin{frame}{Longevity (offline): neighbours of women persist longer}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.6\textwidth}
      \PaperFigureSlot[0.65\textheight]{3B.png}{
